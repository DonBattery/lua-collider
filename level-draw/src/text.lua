...
function _G.loadFont(name, source)
    fonts[name .. "LG"] = love.graphics.newFont(source, fontSizes.large,"mono")
    fonts[name .. "MD"] = love.graphics.newFont(source, fontSizes.medium, "mono")
    fonts[name .. "SM"] = love.graphics.newFont(source, fontSizes.small, "mono")
end
